package com.branko.server;

import com.branko.server.model.Server;
import com.branko.server.repo.ServerRepo;
...
import static com.branko.server.enumeration.Status.SERVER_DOWN;
import static com.branko.server.enumeration.Status.SERVER_UP;
	...
	CommandLineRunner run(ServerRepo serverRepo) {
		return args -> {
			...
			serverRepo.save(new Server(null, "192.168.1.14", "Red Hat Enterprise Linux",
					"64 GB", "Mail Server", "http://localhost:8080/server/image/server4.png", SERVER_DOWN));
		};
	}
